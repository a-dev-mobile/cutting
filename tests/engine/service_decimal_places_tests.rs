...
mod decimal_places_tests {
    ...
    fn test_get_nbr_decimal_places_with_decimals() {
        ...
        assert_eq!(DimensionUtils::get_nbr_decimal_places("0.1"), 1);
    }
    ...
    fn test_get_nbr_decimal_places_without_decimals() {
        ...
        assert_eq!(DimensionUtils::get_nbr_decimal_places("0"), 0);
        assert_eq!(DimensionUtils::get_nbr_decimal_places("999"), 0);
    }
    ...
    fn test_get_nbr_integer_places_basic() {
        ...
        assert_eq!(DimensionUtils::get_nbr_integer_places("0"), 1);
        assert_eq!(DimensionUtils::get_nbr_integer_places("999"), 3);
        assert_eq!(DimensionUtils::get_nbr_integer_places("1"), 1);
    }
    ...
    fn test_comprehensive_decimal_and_integer_places() {
        ...
        assert_eq!(DimensionUtils::get_max_nbr_decimal_places(&panels), 5);
        assert_eq!(DimensionUtils::get_max_nbr_integer_places(&panels), 5);
    }

    #[test]
    fn test_java_compatibility_edge_cases() {
        // Test cases that match Java behavior exactly
        assert_eq!(DimensionUtils::get_nbr_decimal_places("46"), 0);  // Java: str.indexOf(46) where 46 is '.'
        assert_eq!(DimensionUtils::get_nbr_integer_places("46"), 2);
        
        // Test with actual decimal point
        assert_eq!(DimensionUtils::get_nbr_decimal_places("12.34"), 2);
        assert_eq!(DimensionUtils::get_nbr_integer_places("12.34"), 2);
